/*
  # Fix Database Schema and Column Naming

  1. Changes
    - Drop all camelCase columns from campaigns table
    - Ensure all columns use snake_case naming
    - Add proper constraints and defaults
    - Update indexes and foreign keys
    - Fix participations table structure
    
  2. Security
    - Maintain existing RLS policies
    - Add proper triggers for analytics and counters
*/
...
-- Create trigger for participation analytics
...
-- Create trigger for updating campaign participants count
