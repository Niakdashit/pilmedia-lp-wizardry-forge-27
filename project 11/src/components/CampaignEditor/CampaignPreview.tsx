        ...
        <div style={gameContainerStyle}>
          ...
          {campaign.gameConfig && (
            <div 
              style={{
                position: 'absolute',
                left: campaign.gameConfig.position?.x || '50%',
                top: campaign.gameConfig.position?.y || '50%',
                transform: 'translate(-50%, -50%)',
                width: campaign.gameConfig.size?.width || 'auto',
                height: campaign.gameConfig.size?.height || 'auto',
              }}
            >
              {/* Game content */}
            </div>
