        ...
        <div className="relative">
          ...
          <div className="bg-gray-800 rounded-2xl p-4 shadow-2xl">
            <div className="bg-black rounded-xl p-2">
              <div className="bg-white rounded-lg overflow-hidden relative" style={{ width: '300px', height: '400px' }}>
                ...
                <div style={getScreenStyle(mobileConfig)}>
      ...
      <div className="relative">
        ...
        <div className="bg-gray-900 rounded-[2rem] p-2 shadow-2xl">
          <div className="bg-black rounded-[1.5rem] p-1">
            <div className="bg-white rounded-[1.25rem] overflow-hidden relative" style={{ width: '200px', height: '360px' }}>
              {/* Notch */}
