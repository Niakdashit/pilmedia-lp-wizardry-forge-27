...
const GameCanvasPreview: React.FC<GameCanvasPreviewProps> = ({ campaign, className = "" }) => {
  ...
  return (
    <div className={`bg-gray-100 rounded-lg p-6 min-h-[300px] border-2 border-dashed border-gray-300 ${className}`}>
      ...
      <div 
        className="relative bg-white rounded-lg shadow-lg p-6 min-h-[200px] mx-auto max-w-md"
        style={{
