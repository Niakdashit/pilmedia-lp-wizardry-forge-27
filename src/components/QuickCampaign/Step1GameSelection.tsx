        ...
        >
          {gameTypes.map((game, index) => (
            <motion.div
              ...
              className={`relative p-8 rounded-2xl overflow-hidden bg-white/60 backdrop-blur-md shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer border-2 ${
