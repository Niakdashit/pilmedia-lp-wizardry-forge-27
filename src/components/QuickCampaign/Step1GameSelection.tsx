...
const Step1GameSelection: React.FC = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-[#841b60] via-[#f5e6f2] to-[#3a78db] flex items-center justify-center p-6">
      <div className="max-w-6xl w-full">
        ...
        duration: 0.6
          ...
          <h1 className="text-5xl font-bold text-[#841b60]-900 mb-4">
            Quel type d'expérience voulez-vous créer ?
          </h1>
          <p className="text-xl text-[#841b60]-600 mb-2">
            Vous êtes à 2 clics de lancer une campagne interactive.
          </p>
          <p className="text-lg text-[#841b60]-500\n">
        ...
        delay: 0.2
          ...
          scale: 0.95
        }} onClick={() => handleGameSelect(game.id)} className={`relative p-8 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer border-2 ${selectedGameType === game.id ? 'border-blue-500' : 'border-transparent'}`}>
