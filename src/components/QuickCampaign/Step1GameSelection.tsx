  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-6 rounded-3xl">
      <div className="max-w-6xl w-full">
        ...
        delay: 0.2
          ...
          scale: 0.95
        }} onClick={() => handleGameSelect(game.id)} className={`relative p-8 rounded-2xl bg-white/60 backdrop-blur-md shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer border-2 ${selectedGameType === game.id ? 'border-blue-500' : 'border-transparent'}`}>
