  ...
  const presetColorCombinations = [
    {
      ...
      colors: { primary: '#841b60', secondary: '#3b82f6', accent: '#10b981' }
    },
    {
      name: 'Orange Énergique',
      colors: { primary: '#ea580c', secondary: '#dc2626', accent: '#facc15' }
    },
    {
    ...
    {
      name: 'Rose Moderne',
      colors: { primary: '#e11d48', secondary: '#c026d3', accent: '#7c3aed' }
    },
    {
      name: 'Vert Nature',
      colors: { primary: '#16a34a', secondary: '#059669', accent: '#0d9488' }
    },
    {
      name: 'Noir Élégant',
      colors: { primary: '#171717', secondary: '#374151', accent: '#6b7280' }
    }
  ];
      ...
      <div>
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          ...
          <motion.button
            ...
            className="flex items-center space-x-1 sm:space-x-2 px-3 sm:px-4 py-2 sm:py-3 text-gray-600 hover:text-gray-900 transition-colors font-medium rounded-lg sm:rounded-xl hover:bg-gray-100 text-sm sm:text-base"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div>
                ...
                <div className="flex items-center space-x-1 sm:space-x-2">
                  ...
                  {segmentCount > 6 && (
                    <span className="text-xs sm:text-sm text-gray-500 ml-2">+{segmentCount - 6}</span>
                  )}
                </div>
              </div>
            </div>
