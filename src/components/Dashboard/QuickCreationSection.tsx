...
const QuickCreationSection: React.FC = () => {
  ...
  return <div className="w-full mt-8">
      <div className="relative border-1 border-[#ffffff] rounded-3xl p-8 from-[#841b60]/5 to-white overflow-hidden bg-[841b60] bg-[#ffeef6]">
        ...
        <div className="relative z-10">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold mb-2 text-zinc-800">Qu'allez-vous créer aujourd'hui ?</h2>
          </div>
