...
const TiltedCards: React.FC = () => {
  return (
    <div className="mt-12 mb-8">
      <div className="flex flex-col md:flex-row gap-8 md:gap-12 justify-center items-center max-w-4xl mx-auto px-4">
        {/* Carte Mes campagnes - inclinée à gauche */}
        <Link 
          to="/campaigns" 
          className="group relative w-full md:w-80 h-48 transform -rotate-3 hover:-rotate-1 transition-all duration-300 hover:scale-105 hover:shadow-2xl"
        >
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Gérez et suivez toutes vos campagnes actives en un clin d'œil
                </p>
              </div>
            </div>
          </div>
        ...
        <Link 
          to="/templates" 
          className="group relative w-full md:w-80 h-48 transform rotate-2 hover:rotate-1 transition-all duration-300 hover:scale-105 hover:shadow-2xl"
        >
          <div className="w-full h-full bg-gradient-to-br from-blue-50 to-cyan-100 rounded-2xl p-6 shadow-lg border border-blue-100/50 group-hover:shadow-blue-200/50 group-hover:border-blue-200/70 transition-all duration-300">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Découvrez nos modèles prêts à l'emploi pour créer rapidement
                </p>
              </div>
            </div>
          </div>
