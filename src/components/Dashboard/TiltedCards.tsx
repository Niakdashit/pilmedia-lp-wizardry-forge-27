  ...
  return (
    <div className="mt-8">
      <div className="flex flex-col md:flex-row gap-6 justify-center items-center max-w-5xl mx-auto">
        ...
        <Link 
          to="/campaigns" 
          className="group relative w-full h-32 transform -rotate-2 hover:-rotate-1 transition-all duration-300 hover:scale-105 hover:shadow-2xl"
        >
          <div className="w-full h-full bg-gradient-to-br from-pink-50 to-rose-100 rounded-2xl p-6 shadow-lg border border-pink-100/50 group-hover:shadow-pink-200/50 group-hover:border-pink-200/70 transition-all duration-300">
            ...
            <div className="relative z-10 h-full flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-1 group-hover:text-[#841b60] transition-colors duration-300">
                    Mes campagnes
                  </h3>
