  ...
  return (
    <div className="space-y-8">
      ...
      <div className="max-w-3xl">
        <h2 className="text-xl font-bold text-[#141e29] mb-3">Publication de votre campagne</h2>
        ...
        {isPublishing ? (
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="px-8 py-3 bg-[#951b6d] text-white font-semibold rounded-lg hover:bg-[#7d1659] transition-colors shadow-sm hover:shadow-md text-lg"
            >
              Publier maintenant
            </button>
          </div>
      ...
      <div className="flex justify-between pt-6">
        ...
        {isPublished && (
          <button
            onClick={() => navigate('/campaigns')}
            className="px-6 py-3 bg-[#951b6d] text-white font-semibold rounded-lg hover:bg-[#7d1659] transition-colors shadow-sm hover:shadow-md ml-auto"
          >
            Voir mes campagnes
          </button>
        )}
