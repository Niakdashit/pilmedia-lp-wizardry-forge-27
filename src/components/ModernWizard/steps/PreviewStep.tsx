  ...
  return (
    <div className="space-y-8">
      ...
      <div className="max-w-3xl">
        <h2 className="text-xl font-bold text-[#141e29] mb-3">Aperçu de votre campagne</h2>
        ...
        <div className="bg-gray-50 rounded-lg p-8 min-h-96 flex items-center justify-center">
          <div className="text-center space-y-4">
            {selectedDevice === 'desktop' && (
              <div className="w-96 h-64 bg-white rounded-lg shadow-sm border border-gray-200 flex items-center justify-center">
            ...
            {selectedDevice === 'tablet' && (
              <div className="w-80 h-60 bg-white rounded-lg shadow-sm border border-gray-200 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-16 h-16 bg-[#951b6d]/10 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            {selectedDevice === 'mobile' && (
              <div className="w-64 h-96 bg-white rounded-lg shadow-sm border border-gray-200 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-16 h-16 bg-[#951b6d]/10 rounded-full flex items-center justify-center mx-auto mb-4">
