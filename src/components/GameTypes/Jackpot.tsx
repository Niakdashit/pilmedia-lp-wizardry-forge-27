      ...
      >
        {result ? (
          ...
          <button
            onClick={roll}
            disabled={isRolling}
            className="px-8 py-3 bg-[#FF4B8B] text-white font-medium rounded-xl shadow-lg hover:bg-[#e4437a] transition-colors duration-200 disabled:opacity-50"
            style={{
              fontSize: 20,
              marginTop: 4,
            }}
