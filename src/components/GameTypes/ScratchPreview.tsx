...
const ScratchCard: React.FC<{
  ...
  return <div className="flex flex-col items-center">
      {gameStarted && !isRevealed && <div className="text-center mb-2">
      ...
      <div className="relative rounded-lg overflow-hidden border-2 border-gray-300" style={{
      width: `${width}px`,
      height: `${height}px`
    }}>
        {/* Contenu à révéler */}
        ...
        {/* Canvas de grattage */}
        {gameStarted && !isRevealed && <canvas ref={canvasRef} className="absolute inset-0 w-full h-full cursor-crosshair" style={{
        touchAction: 'none'
      }} />}
...
const ScratchPreview: React.FC<ScratchPreviewProps> = ({
  ...
  if (!gameStarted) {
    return <div className="flex flex-col items-center space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mx-0 px-0 py-0 my-0">
