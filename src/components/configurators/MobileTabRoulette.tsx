    ...
    <div className="space-y-8">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-blue-800 text-sm">
          <strong>Configuration Mobile de la Roue</strong><br />
          Ces paramètres s'appliquent uniquement à l'affichage mobile et sont indépendants de la configuration desktop.
        </p>
      </div>
