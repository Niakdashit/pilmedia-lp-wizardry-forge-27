  ...
  if (variant === 'default') {
    return <div className="relative w-full mt-3 py-7 px-2 select-none md:px-[19px]">
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          <div className="absolute -inset-10 bg-gradient-to-br from-[#dbeafe]/40 via-[#f3e8ff]/60 to-[#fdf2f8]/50 rounded-full blur-2xl" />
        </div>
        {/* Main glassy card */}
        <div className="relative max-w-7xl mx-auto z-10">
          <div className="relative backdrop-blur-md [0_4px_32px_0_rgba(132,27,96,0.05)] rounded-full px-6 md:px-16 py-10 flex flex-col items-center text-center bg-[#428cec]/[0.14]">
