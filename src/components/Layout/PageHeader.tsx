...
const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  if (variant === 'default') {
    return (
      <div className="relative w-full py-7 px-2 md:px-0 select-none">
        ...
        <div className="relative max-w-7xl mx-auto z-10">
          <div className="relative bg-white/70 backdrop-blur-md border border-white/75 shadow-xl shadow-[#841b60]/10 rounded-[36px] px-6 md:px-16 py-10 flex flex-col items-center text-center">
