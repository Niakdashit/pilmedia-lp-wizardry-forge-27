...
const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  if (variant === 'default') {
    return (
      <div className="relative w-full mt-3 py-7 px-2 md:px-0 select-none">
        ...
        <div className="relative max-w-7xl mx-auto z-10">
          <div
            className="relative bg-white/70 backdrop-blur-md border border-white/75 
            shadow-[0_4px_32px_0_rgba(132,27,96,0.05)]
            rounded-[36px] px-6 md:px-16 py-10 flex flex-col items-center text-center"
          >
            {/* Fine white border for depth */}
            <div className="absolute inset-0 border-2 border-white/60 rounded-[36px] pointer-events-none" style={{ zIndex: 1 }} />
