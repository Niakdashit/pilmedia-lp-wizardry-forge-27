  ...
  if (variant === 'default') {
    return <div className="relative w-full mt-3 py-7 px-2 select-none md:px-[19px]">
        ...
        <div className="relative max-w-7xl mx-auto z-10">
          <div className="relative backdrop-blur-md [0_4px_32px_0_rgba(132,27,96,0.05)] rounded-[25px] px-6 md:px-16 py-10 flex flex-col items-center text-center bg-[#428cec]/[0.14]">
