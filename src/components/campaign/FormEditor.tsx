...
const FormEditor: React.FC<FormEditorProps> = ({ formFields, setFormFields }) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            <button
              onClick={addField}
              className="flex items-center gap-2 bg-[#841b60] text-white px-4 py-2 rounded-lg hover:bg-[#6d1550] transition-colors"
            >
