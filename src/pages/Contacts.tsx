...
const Contacts: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'subscribed', label: 'Abonnés à la newsletter' },
    { id: 'unsubscribed', label: 'Désabonnés' },
    ...
    <div className="-mx-6 -mt-6">
      <div className="relative h-[100px] bg-[#841b60] overflow-hidden">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white mb-4">Contacts</h1>
          </div>
          <div className="flex space-x-3">
            <button
              onClick={() => setShowImportModal(true)}
              className="inline-flex items-center px-4 py-2 bg-white/20 text-white font-medium rounded-xl hover:bg-white/30 transition-all duration-200"
            >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex flex-wrap gap-2">
                        {contact.topics.map((topic, index) => (
                          <span
                            key={index}
                            className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#f8f0f5] text-[#841b60]"
                          >
                            {topic}
                          </span>
                        ))}
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#841b60]"
                  onChange={(e) => setNewContact({ ...newContact, topics: e.target.value.split(',').map(t => t.trim()) })}
                />
              </div>
                    ...
                    <label key={channel} className="flex items-center">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (e.target.checked) {
                            setNewContact({ ...newContact, channels: [...channels, channel] });
                          } else {
                            setNewContact({ ...newContact, channels: channels.filter(c => c !== channel) });
                          }
                        }}
                        className="rounded border-gray-300 text-[#841b60] focus:ring-[#841b60]"
                      />
